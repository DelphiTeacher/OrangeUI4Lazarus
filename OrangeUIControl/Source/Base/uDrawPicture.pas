...
//    property IsClipRound;
  ...
  TSkinPictureList=TDrawPictureList;
    ...
    private
      function GetItem(Index: Integer): TDrawPictureItem;
      function GetItemByName(const AName: String): TDrawPictureItem;
    ...
    public
      ...
      ///   </para>
      /// </summary>
      function Add:TDrawPictureItem;overload;
    ...
    public
      function FindImageNameIndex(AImageName:String):Integer;
      property Items[Index:Integer]:TDrawPictureItem read GetItem write SetItem;default;
      //使用ImageName
      property ItemsByName[const Name:String]:TDrawPictureItem read GetItemByName;
    end;
...
begin
  ...
  begin
    ...
    begin
      Result:=ASkinBaseImageList.PictureList.ItemsByName[DefaultImageName].FDrawPicture;
    end;


    if (ASkinBaseImageList<>nil) and (Self.DefaultImageIndex<>-1) then
    begin
      Result:=ASkinBaseImageList.PictureList.Items[DefaultImageIndex].FDrawPicture;
    end;
...
function TBaseDrawPicture.GetSelfPicture:TSkinPicture;
begin
  Result:=Self;
end;

procedure TBaseDrawPicture.SetSelfPicture(const Value: TSkinPicture);
begin
  Self.Assign(Value);
end;
...
begin
  ...
  begin
    ...
    begin
      Result:=Self.SkinImageList.PictureList[Self.FCurrentEffectImageIndex].FDrawPicture.CurrentPicture;
    end
    else if (Self.FImageIndex<>-1)
      and (Self.FImageIndex<Self.SkinImageList.Count) then
    begin
      Result:=Self.SkinImageList.PictureList[Self.FImageIndex].FDrawPicture.CurrentPicture;
    end;
...
begin
  ...
  begin
    ...
    begin
      Result:=Self.SkinImageList.PictureList.ItemsByName[FCurrentEffectImageName].FDrawPicture.CurrentPicture;
    end
    else if (Self.FImageName<>'') and (Self.SkinImageList.PictureList.ItemsByName[Self.FImageName]<>nil) then
    begin
      Result:=Self.SkinImageList.PictureList.ItemsByName[Self.FImageName].FDrawPicture.CurrentPicture;
    end;
...
function TDrawPictureCollection.GetItem(Index: Integer): TDrawPictureItem;
begin
  Result:=TDrawPictureItem(Inherited Items[Index]);
end;


function TDrawPictureCollection.GetItemByName(const AName: String): TDrawPictureItem;
var
  I: Integer;
  AScale:Integer;
  AScaleName:String;
begin
  ...
  begin
    ...
    for I := 0 to Self.Count-1 do
    begin
      if Items[I].FDrawPicture.ImageName=AScaleName then
      begin
        Result:=Items[I];
        Break;
      end;
...
function TDrawPictureCollection.Add: TDrawPictureItem;
begin
//  Result:=CreateCurrentEngineDrawPicture('','');
...
begin
  Self.Items[AIndex].FDrawPicture.FileName:=ExtractFileName(AFileName);
end;
...
begin
  ...
  for I := 0 to Self.Count-1 do
  begin
    if Items[I].FDrawPicture.ImageName=AImageName then
    begin
      Result:=I;
      Break;
    end;
