...
//  begin
    ...
    begin
      PtInBarRect:=True;
      PtInSwitchBtnRect:=PtInRectF(Self.GetSwitchBtnDrawRect(Self.FSkinSwitchBarIntf.Prop.Position),FMouseMovePt);
    end;
...
begin
  ...
  begin
    ...
    OffsetRectF(ASwitchBtnRect,ADrawRect.Left,ADrawRect.Top);
