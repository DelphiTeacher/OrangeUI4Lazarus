...
//    FFieldName:String;
    ...
    FItemColorIntf: IProcessItemColor;
  end;
...
begin
  ...
  begin
    ...
    FPreviewItem:=TDesignTimeRealSkinTreeViewItem.Create(nil);//(nil);
...
begin
  ...
  begin
    ...
    if (AItemBindingControlItem<>nil) and (AItemBindingControlItem.FItemColorIntf<>nil) then
    begin
      AItemBindingControlItem.FItemColorIntf.ProcessItemColor(AItemColorType,AItemColorFieldName,AItemColorFieldSetType,AItemColor,AOldColor);
    end;
  end;
...
begin
  ...
  begin
    ...
    if (AItemBindingControlItem<>nil) and (AItemBindingControlItem.FItemColorIntf<>nil) then
    begin
      AItemBindingControlItem.FItemColorIntf.RestoreItemColor(AItemColorType,AItemColorFieldName,AItemColorFieldSetType,AItemColor,AOldColor);
    end;
  end;
