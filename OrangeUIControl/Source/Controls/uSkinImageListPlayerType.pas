...
begin
  ...
  begin
    Result:=Self.FPicture.SkinImageList.PictureList[GetCurrentAfterPictureImageIndex].FDrawPicture;
  end;
end;
...
begin
  ...
  begin
    Result:=Self.FPicture.SkinImageList.PictureList[GetCurrentBeforePictureImageIndex].FDrawPicture;
  end;
end;
