...
begin
  inherited;
      ...
      if PtInRectF(RectF(0,0,Self.FSkinControlIntf.Width,Self.FSkinControlIntf.Height),Self.FMouseMovePt) then
      begin
        PtInMinBtnRect:=PtInRectF(Self.GetMinBtnRect,Self.FMouseMovePt);
        PtInMaxBtnRect:=PtInRectF(Self.GetMaxBtnRect,Self.FMouseMovePt);

        if (Self.FSkinScrollBarIntf.Prop.CalcDistance)>0 then
        begin
          PtInThumbBtnRect:=PtInRectF(Self.GetThumbBtnDrawRect,Self.FMouseMovePt);
          PtInMinSpaceRect:=PtInRectF(Self.GetMinSpaceRect,Self.FMouseMovePt);
          PtInMaxSpaceRect:=PtInRectF(Self.GetMaxSpaceRect,Self.FMouseMovePt);
        end;
      end;
