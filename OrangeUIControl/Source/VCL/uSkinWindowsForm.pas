...
//    property FormSysCaption:TSkinChildLabel read GetFormSysCaption;
    ...
    //关闭按钮
    property CloseSysBtn:TSkinChildButton read FCloseSysBtn;
    //还原/最大化按钮
    property MaxRestoreSysBtn:TSkinChildButton read FMaxRestoreSysBtn;
    //最小化按钮
    property MinSysBtn:TSkinChildButton read FMinSysBtn;
    //窗体图标
    property FormSysIcon:TSkinChildImage read FFormSysIcon;
    //窗体标题
    property FormSysCaption:TSkinChildLabel read FFormSysCaption;
