...
type
  ...
  //TDrawPicture属性编辑器,可以展开DrawPicture属性
...
begin
  ...
  RegisterComponentEditor(TSkinImage,TSkinImageEditor);
  //组件编辑器
  {$IFDEF FMX}
...
begin
  //ShowMessage('TDrawPicturePropertyEditor.Edit');
...
begin
  //要加paDialog，不然在Lazarus下面双击弹不出选择框
