...
//7. 南极洲 - Antarctica
  ...
  begin
    ...
    else if Result='非洲' then
    begin
      Result:='africa';
    end
    else if Result='欧洲' then
    begin
      Result:='europe';
    end
    else if (Result='北美洲') or (Result='北美') or (Result='拉美') then
    begin
      Result:='north america';
    end
    else if (Result='南美洲') or (Result='南美') then
    begin
      Result:='south america';
    end
    else if (Result='大洋洲') or (Result='大洋') or (Result='澳洲') then
    begin
      Result:='oceania';
    end
    else if (Result='南极洲') or (Result='南极') then
    begin
      Result:='antarctica';
    end
    else
