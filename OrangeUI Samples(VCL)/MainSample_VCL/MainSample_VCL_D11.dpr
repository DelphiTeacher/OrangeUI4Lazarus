...
uses
  ...
  GridSwitchPageFrame in '..\..\OrangeProjectCommon\VCLFrames\GridSwitchPageFrame.pas' {FrameGridSwitchPage: TFrame},
  GridSwitchPage2Frame in '..\..\OrangeProjectCommon\VCLFrames\GridSwitchPage2Frame.pas' {FrameGridSwitchPage2: TFrame},
  MainForm in 'MainForm.pas' {frmMain},
  uCxDBGridColumnItemDesignerPanelManager in '..\..\OrangeProjectCommon\VCLFrames\uCxDBGridColumnItemDesignerPanelManager.pas',
  BaseQueryFrame2 in 'BaseQueryFrame2.pas' {FrameBaseQuery2: TFrame},
  uVCLSVGSupport in '..\..\OrangeProjectCommon\uVCLSVGSupport.pas',
  uJsonToDataset in '..\..\OrangeProjectCommon\uJsonToDataset.pas',
  FormWaiting in '..\..\OrangeProjectCommon\WaitingForm_VCL\FormWaiting.pas',
  uWaiting in '..\..\OrangeProjectCommon\WaitingForm_VCL\uWaiting.pas',
  uWaitingForm in '..\..\OrangeProjectCommon\WaitingForm_VCL\uWaitingForm.pas',
...
//  begin
//  uGraphicCommon.GlobalFilePictureSearchPaths.Add(GetApplicationPath+'icons\');

  Application.CreateForm(TdmEasyServiceCommonMaterial, dmEasyServiceCommonMaterial);
  Application.CreateForm(TfrmMain, frmMain);
  //  Application.CreateForm(TFrameGridSwitchPage2, FrameGridSwitchPage2);
//  Application.CreateForm(TfrmMain, frmMain);
