...
var
  frmWhiteMain: TfrmWhiteMain;

implementation

{$R *.dfm}

procedure TfrmWhiteMain.btnAddRightTabSheetClick(Sender: TObject);
//var
...
procedure TfrmWhiteMain.btnAddSubMenuClick(Sender: TObject);
//var
//  ASkinItem:TSkinItem;
begin
...
procedure TfrmWhiteMain.btnCloseClick(Sender: TObject);
begin
  Close;
end;

procedure TfrmWhiteMain.btnCreateCustomerClick(Sender: TObject);
begin
  //
end;

procedure TfrmWhiteMain.btnMinClick(Sender: TObject);
begin
  WindowState:=wsMinimized;
end;

procedure TfrmWhiteMain.btnNormalClick(Sender: TObject);
begin
...
procedure TfrmWhiteMain.btnSearchClick(Sender: TObject);
begin
  ShowMessage('搜索');
end;

procedure TfrmWhiteMain.btnSelectCountryClick(Sender: TObject);
begin
  //
end;

procedure TfrmWhiteMain.CreateParams(var Params: TCreateParams);
begin
  inherited;
  //无边框,但也不能拉伸
...
procedure TfrmWhiteMain.FormCreate(Sender: TObject);
var
  ASkinItem:TSkinItem;
...
procedure TfrmWhiteMain.FormShow(Sender: TObject);
begin
  Load;
end;

procedure TfrmWhiteMain.fsdFormSyncSystemControls(Sender: TObject);
begin
...
procedure TfrmWhiteMain.lbMainMenuClickItem(AItem: TSkinItem);
begin
  ShowMessage(AItem.Caption);
end;

procedure TfrmWhiteMain.lbSubMenuClickItem(AItem: TSkinItem);
begin
  //ShowMessage(AItem.Caption);
  ...
  begin
    FCurrentFrame:=TFrameListBox.Create(Self);
  end;
...
procedure TfrmWhiteMain.lbSubMenuClickItemDesignerPanelChild(Sender: TObject;
  AItem: TBaseSkinItem; AItemDesignerPanel: TSkinItemDesignerPanel;
  AChild: TControl);
begin
...
procedure TfrmWhiteMain.lbSubMenuMouseLeave(Sender: TObject);
begin
...
procedure TfrmWhiteMain.lbSubMenuMouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
//var
//  I: Integer;
//  AItem:TSkinItem;
...
procedure TfrmWhiteMain.lbSubMenuPrepareDrawItem(Sender: TObject;
...
procedure TfrmWhiteMain.N1Click(Sender: TObject);
begin
  ShowMessage('聊天记录');
end;

procedure TfrmWhiteMain.N2Click(Sender: TObject);
begin
  ShowMessage('删除');
end;

procedure TfrmWhiteMain.N3Click(Sender: TObject);
begin
  ShowMessage('转交');
end;

procedure TfrmWhiteMain.N4Click(Sender: TObject);
begin
  ShowMessage('建群');
end;

procedure TfrmWhiteMain.N5Click(Sender: TObject);
begin
  ShowMessage('客户详情');
end;

procedure TfrmWhiteMain.Timer1Timer(Sender: TObject);
begin
//  Self.lbSubMenu.Invalidate;
end;

procedure TfrmWhiteMain.lbContactClickItemDesignerPanelChild(Sender: TObject;
  AItem: TBaseSkinItem; AItemDesignerPanel: TSkinItemDesignerPanel;
  AChild: TControl);
var
  AItemRectF:TRectF;
...
procedure TfrmWhiteMain.lbContactPrepareDrawItem(Sender: TObject;
  ACanvas: TDrawCanvas; AItemDesignerPanel: TSkinItemDesignerPanel;
  AItem: TSkinItem; AItemDrawRect: TRect);
//var
